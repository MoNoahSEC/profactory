@extends('layouts.app')
@section('title', 'طلبية جديدة | ' . ($globalSettings['company_name'] ?? config('app.name')))
...
<form action="{{ route('orders.store') }}" method="POST" id="ORD_FORM">
@csrf
...
<div class="row g-3">
    ...
    <div class="col-lg-8">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <div style="position:relative;">
                        ...
                        <input type="hidden" name="customer_id" id="ORD_CUST_ID">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" name="order_date" value="{{ date('Y-m-d') }}" class="form-control" style="border-radius:10px;" required>
                </div>
                <div class="col-md-3">
                    <label class="form-label fw-bold small">التسليم المتوقع</label>
                    <input type="date" name="expected_date" class="form-control" style="border-radius:10px;">
                </div>
            </div>
            <div class="row g-3 mt-1">
                <div class="col-md-6">
                    <label class="form-label fw-bold small">تاريخ التسليم الفعلي</label>
                    <input type="date" name="delivery_date" class="form-control" style="border-radius:10px;">
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-bold small">عنوان التوصيل</label>
                    <input type="text" name="address" class="form-control" style="border-radius:10px;" placeholder="أدخل العنوان للتوصيل...">
                </div>
            </div>
        </div>
        ...
        <div class="inv-card">
            ...
            <textarea name="notes" class="form-control" rows="2" style="border-radius:10px;" placeholder="ملاحظات تظهر على الطلبية..."></textarea>
        </div>
    </div>
    ...
    {{-- RIGHT --}}
        <div class="summary-box">
            ...
            <div class="mt-4">
                <label class="slabel small mb-1">مبلغ العربون المدفوع (اختياري)</label>
                <input type="number" name="paid_deposit" id="ORD_PAID" min="0" step="0.01"
                       ...
                       placeholder="0.00" oninput="ORD.calc()">
                <div class="small mt-2 text-warning"><i class="bi bi-info-circle"></i> سيتم إضافة هذا العربون لحساب العميل كدفعة.</div>
            </div>
            <div class="srow mt-3">
